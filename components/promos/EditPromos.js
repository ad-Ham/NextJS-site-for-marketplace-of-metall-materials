...
export function EditPromos({ user }) {
    ...
    const changePromo = useForm({
        initialValues: {
            title: '',
            category : ''
        }
    })
    console.log(changePromo.values)
    ...
    return (<>
        ...
        <MediaQuery smallerThan="sm" styles={{ display: 'none' }}>
            <Grid justify="space-between" align='flex-end' columns={4} style={{marginTop: 15}}>          
                <Grid.Col span={3} onSubmit={changePromo.onSubmit((values) => console.log(values))}>
                    <TextInput
                ...
                <Grid.Col span={1}>
                    ...
                    size="sm"
                    required
                    {...changePromo.getInputProps('category')}
                    />
                </Grid.Col>
            </Grid>
         </MediaQuery>  
